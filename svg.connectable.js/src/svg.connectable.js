...
; (function () {
    ...
    var container = null;
    var markers = null;
    var sourceBoxPos = null;
    var targetBoxPos = null;
    ...
    function connectable(options, elmTarget) {
        ...
        con.computeConnectorCoordinates = function (con) {
            ...
            if (con.type == 'curved') {
            ...
            } else if (con.type == 'angled') {
                if (sourceBoxPos == 1 || sourceBoxPos == 3) {
                    if (targetBoxPos == 1 || targetBoxPos == 3) {
                        var points = [
                            ['M', pp1[0], pp1[1]],
                            ['L', Math.floor((pp1[0] + pp2[0]) / 2), pp1[1]],
                            ['L', Math.floor((pp1[0] + pp2[0]) / 2), pp2[1]],
                            ['L', pp2[0], pp2[1]]
                        ]
                    } else {
                        var points = [
                ...
                } else if (sourceBoxPos == 2 || sourceBoxPos == 0) {
                    if (targetBoxPos == 2 || targetBoxPos == 0) {
                        var points = [
                            ['M', pp1[0], pp1[1]],
                            ['L', pp1[0], Math.floor((pp1[1] + pp2[1]) / 2)],
                            ['L', pp2[0], Math.floor((pp1[1] + pp2[1]) / 2)],
                            ['L', pp2[0], pp2[1]]
                        ]
                    } else {
                        var points = [
